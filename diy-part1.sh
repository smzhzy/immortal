...
sed -i '20,25d' target/linux/x86/Makefile
sed -i '19a\DEFAULT_PACKAGES += partx-utils mkf2fs fdisk e2fsprogs kmod-usb-hid kmod-mmc-spi kmod-sdhci kmod-igb vim htop lm-sensors autocore-x86 automount autosamba ddns-scripts_aliyun ddns-scripts_dnspod ca-certificates' target/linux/x86/Makefile
